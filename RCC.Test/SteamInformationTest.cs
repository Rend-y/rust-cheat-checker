...
namespace RCC.Test
{
    ...
    public class SteamInformationTest
    {
        ...
        [Theory]
        [InlineData("Some text 76561198012345678 and more text", new[]
        {
            "76561198012345678"
        })]
        [InlineData("76561198012345678 and 76561198098765432 are Steam IDs",
            new[]
            {
                "76561198012345678", "76561198098765432"
            })]
        [InlineData("76561198012345678 and 76561198012345678 are overlapping Steam IDs", new[]
        {
            "76561198012345678"
        })]
        [InlineData("Some text 1234567890123456 and more text", new string[0])]
        [InlineData("Steam ID: 765611980123 and more text", new[]
        {
            "765611980123"
        })]
