...
namespace RCC.Pages
{
    public partial class UsbDevicePage : Page
    {
        ...
        void BackgroundWorkerFindUsbDeviceDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            var loadXmlDocument = Utilities.GetXmlDocumentFromWebProcess(localPathToFile, "https://github.com/Midoruya/rust-cheat-checker/blob/main/Resources/USBDeview.exe?raw=true", pathToSaveUsbList);
        ...
        void BackgroundWorkerFindUsbDeviceProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            ListAllUsbDevice.Items.Add(new UsbDeviceInfo(usbData.DeviceName, usbData.Description, usbData.DeviceType, usbData.IsConnect, usbData.TimeLastUsed, usbData.CreatingTime));
        }
