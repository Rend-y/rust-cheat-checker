...
public class SteamInformation : ISteamInformation<SteamData>
{
    ...
    public string PathToLoginData => $"{GetSteamLocation()}\\config\\loginusers.vdf";

    public string PathToSteamConfig => $"{GetSteamLocation()}\\config\\config.vdf";
}